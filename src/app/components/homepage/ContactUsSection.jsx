    ...
    return (
        <section className='flex flex-col gap-8 my-6 mb-12'>
            ...
            <div className='xl:w-full lg:w-full md:w-[85%] w-[80%] mx-auto grid xl:flex lg:grid-cols-3 md:grid-cols-2 grid-cols-1 justify-center justify-items-center gap-3'>
                ...
                {/* right sub - section */}
                <div class="xl:w-fit md:w-full md:col-span-2 xl:px-4 lg:col-span-1 bg-white">
                    <form class="space-y-4 w-full">
                        ...
                        {/* comments input */}
                        <textarea rows={5} placeholder="Message" className="h-fit text-area w-full p-2.5 text-sm border border-gray-300 rounded-none shadow-none focus:outline-none focus:ring-0 focus:border-blueVoilet"></textarea>
